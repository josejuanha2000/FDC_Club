...
Public Class Inventario_hojas
    ...
    Private Sub Inventario_hojas_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Sub carga_hojas_cta()
        Try
            ...
            sql_hojascta.CommandText = ("select Hojas_Carta  from Paquetes_Hojas")
    ...
    Sub carga_hojas_oficio()
        Try
            ...
            sql_hojasoficio.CommandText = ("select *  from Paquetes_Hojas")
    ...
    Private Sub CB_hojas_carta_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CB_hojas_carta.SelectedIndexChanged
        Call cargar_inventario_hojas_CARTA()
        hojas_cta = CInt(CB_hojas_carta.Text) * 500
        'MsgBox("hojas_cta " & hojas_cta)
        inv_hojas_cta = hojas_cta + CInt(TB_Existencia_cta.Text)
    ...
    Private Sub CB_Hojas_Oficio_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles CB_Hojas_Oficio.SelectedIndexChanged
        Call cargar_inventario_hojas_OFICIO()
        hojas_oficio = CInt(CB_Hojas_Oficio.Text) * 500
        'MsgBox("hojas_oficio " & hojas_oficio)
        inv_hojas_oficio = hojas_oficio + CInt(TB_Existencia_Oficio.Text)
